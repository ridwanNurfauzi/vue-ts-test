<template>
    <div class="flex-1 flex flex-col bg-[url('/images/bg1.jpg')] bg-cover bg-center sm:py-12">
        <div
            class="m-0 my-auto sm:mx-auto sm:w-[580px] flex-grow sm:flex-grow-0 flex flex-col bg-gray-50 bg-opacity-[.65] p-8 sm:rounded-xl shadow-lg backdrop-blur-sm">
